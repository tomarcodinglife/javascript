document.getElementById('generate-btn').addEventListener('click', () => {
    ...
    downloadButton.classList.add('visible'); // 'hidden' हटाने के बजाय 'visible' जोड़ें
});
...
document.getElementById('download-btn').addEventListener('click', () => {
    ...
    setTimeout(() => {
        ...
        html2pdf().set(opt).from(cert).save().catch(error => {
            console.error("PDF डाउनलोड में एरर:", error);
        });
    }, 500);
});